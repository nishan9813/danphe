...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtTokenProvider jwtTokenProvider, ClientUserService service) {
        ...
        resolveToken(request)
                ...
                .ifPresent(token -> {
                    ...
                    if (SecurityContextHolder.getContext().getAuthentication() == null) {
                        service.findById(userId).ifPresent(systemUser -> {
                            ClientUserPrincipal principal = new ClientUserPrincipal(systemUser);
